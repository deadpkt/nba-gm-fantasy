...
function LeagueProgress({ compact = false, contracts }) {
  ...
  return (
    <section
      className={`league-guide ${compact ? "league-guide--compact" : ""}`}
      aria-label="League progress and next action"
    >
      <div className="league-guide__action">
        ...
        <Link
          className={`basketball-action basketball-action--${guidance.actionType}`}
