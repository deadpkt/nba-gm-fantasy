  ...
  return (
    ...
    >
      <g fill="none" vectorEffect="non-scaling-stroke">
        <rect
          className="decorative-court__line"
          x="20"
          y="20"
          width="900"
          height="460"
        ...
        <path
          className="decorative-court__paint"
          d="M20 166h190v168H20M920 166H730v168h190"
        />
        ...
        <path
          className="decorative-court__detail"
          strokeDasharray="8 8"
          d="M210 189a61 61 0 0 0 0 122M730 189a61 61 0 0 1 0 122"
        />

        <path
          className="decorative-court__line"
          d="M20 70h92A225 225 0 0 1 112 430H20M920 70h-92a225 225 0 0 0 0 360h92"
        />
        ...
        <path
          className="decorative-court__detail"
          d="M74 220a30 30 0 0 1 0 60M866 220a30 30 0 0 0 0 60"
        />
      </g>
    </svg>
  );
