...
`node scripts/ratings/recalibrateRatingsPreview.mjs --input local-data/ratings/archive/goat-ratings-preview-2025-v2.2.json --output local-data/ratings/archive/goat-ratings-preview-2025-v2.3.json --formula ratings-v2.3.0`
